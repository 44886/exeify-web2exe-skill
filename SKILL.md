---
name: exeify-packer
description: "Use when the user wants to package a website into a standalone Windows .exe — either a local HTML/CSS/JS folder or an online URL — that double-clicks to run with no install (uses the system WebView2). Drives the bundled exeify.exe CLI. Windows only. Triggers: 打包成exe / package website to exe / 网页转exe / 把网址做成桌面程序 / turn HTML folder into a desktop app."
license: Apache-2.0
